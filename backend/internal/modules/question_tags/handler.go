...
func (h Handler) List(c *fiber.Ctx) error {
	...
	out, err := h.service.List(c.Context(), shared.TenantID(c), shared.UserID(c), shared.Permissions(c), q)
	if err != nil {
		return err
	}
...
func (h Handler) Get(c *fiber.Ctx) error {
	...
	out, err := h.service.Get(c.Context(), shared.TenantID(c), shared.UserID(c), shared.Permissions(c), id)
	if err != nil {
		return err
	}
	return response.OK(c, out)
...
func (h Handler) Create(c *fiber.Ctx) error {
	var req CreateQuestionTagRequest
...
func (h Handler) Update(c *fiber.Ctx) error {
	...
	var req UpdateQuestionTagRequest
	if err := c.BodyParser(&req); err != nil {
		return response.Error(c, fiber.StatusBadRequest, "invalid payload", err)
	}
...
func (h Handler) Delete(c *fiber.Ctx) error {
	...
	if err := h.service.Delete(c.Context(), shared.TenantID(c), id, shared.UserID(c), shared.Permissions(c)); err != nil {
