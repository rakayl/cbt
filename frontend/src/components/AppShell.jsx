...
const nav = [
  ...
  ['/grading-review', 'Review Hasil', ClipboardCheck, 'grading:read'],
  ['/exam-rankings', 'Peringkat Ujian', Trophy, 'exams:read'],
...
const pageHeaders = {
  ...
  '/exams/': { title: 'Detail Ujian', eyebrow: 'Exam Management' },
  ...
  '/grading-review': { title: 'Review Hasil', eyebrow: 'Grading Center' },
  '/exam-rankings': { title: 'Peringkat Ujian', eyebrow: 'Ranking Center' },
